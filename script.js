  ...
  const requestOptions = {
    ...
    body: JSON.stringify({
      ...
      messages: [
        {
          role: "user",
          content: "querry = "+userMessage+ "- either covert the query to emoji or respond  unrelated to query only do one",
        },
      ],
    }),
  };
  ...
  fetch(API_URL, requestOptions)
    ...
    .catch(() => {
      ...
      messageElement.textContent =
        "Oops our developer has procrastined the process of API . Please try again or genetate an API and link it.";
    })
